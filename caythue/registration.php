        ...
        <div class="sidebar">
            ...
            <nav>
                <ul class="mother-content">
                    ...
                    <li class="main-content"><a href="caythue/dashboard.php">Đăng nhập</a></li>
                </ul>
                <div class="icon">
...
?>
    ...
    <form class="form" action="" method="post">
        ...
        <input type="text" class="login-input" name="username" autocomplete="off" placeholder="Tên đăng ký" title="Tên đăng ký" required /><br><br>
        ...
        <p class="link">Có tài khoản r sao?<br><a href="login.php">Đăng nhập đê</a></p>
    </form>
<?php
    }
?>
